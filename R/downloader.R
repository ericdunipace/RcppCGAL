...
#'
#'
#' @return Invisibly returns TRUE if the `CGAL_DIR` variable was successfully set or or FALSE if it was not.
#'
#' @seealso [unset_cgal()]
#'
#' @export
...
.not_needed <- function(temp_file, dest_folder, own = FALSE) {
  ...
  if (!file.exists(source_file)) {
    stop("Error! The headerfiles were not decompressed properly!")
  }
