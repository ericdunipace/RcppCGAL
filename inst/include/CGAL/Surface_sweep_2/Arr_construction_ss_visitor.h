...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.4.1/Arrangement_on_surface_2/include/CGAL/Surface_sweep_2/Arr_construction_ss_visitor.h $
...
#if CGAL_ARR_CONSTRUCTION_SS_VISITOR_VERBOSE
  Rcpp::Rcout << "map " << i << " to ";
  if (he == Halfedge_handle()) Rcpp::Rcout << "null halfedge";
  else Rcpp::Rcout << he->curve() << " " << he->direction();
  Rcpp::Rcout << std::endl;
#endif
  CGAL_assertion(i != 0);
