...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.4.1/Weights/include/CGAL/Weights/internal/pmp_weights_deprecated.h $
...
public:
  ...
  double operator()(halfedge_descriptor he) {
    ...
    // if (weight < 0.0) { Rcpp::Rcout << "Negative weight!" << std::endl; }
