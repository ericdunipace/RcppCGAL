...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.4.1/Filtered_kernel/include/CGAL/Filtered_kernel/internal/Static_filters/Orientation_2.h $
...
public:
  ...
  static double compute_epsilon()
  {
    ...
    Rcpp::Rcerr << "*** epsilon for Orientation_2 = " << err << std::endl;
    return err;
  }
};
